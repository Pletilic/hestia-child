...
<!-- Denne kode er uddokumenteret, da Singleview i "pop-up" format ikke havde det ønskede visuelle udtryk.
For i øvrigt stemte dette heller ikke overens med prototypen.
    <section id="popup">
...
<style>
    ...
    /* Bemærk at knappen har fået fjernet al padding og margin for at muliggøre, at billedet, som er
    "indlejret" i hver knap, vises i fuldt omgang */
    ...
    /* main har fået en custom width, så den aligner med tema templaten. Repeat(autofill) er angivet,
    så antal produkter tilpasses skærmens størrelse/opløsning */
    ...
    /* Udkommenteret. Læs årsag foroven.
...
<script>
    ...
    /*
        Strict mode makes several changes to normal JavaScript semantics. First, strict mode eliminates some JavaScript 
        silent errors by changing them to throw errors. Second, strict mode fixes mistakes that make it difficult for 
        JavaScript engines to perform optimizations: strict mode code can sometimes be made to run faster than identical 
        code that's not strict mode. Third, strict mode prohibits some syntax likely to be defined in future versions of ECMAScript.    
    */
    "use strict";
    ...
    // Her defineres der globale "block level" variabler
